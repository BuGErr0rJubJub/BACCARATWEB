...
//setInterval("move()",30); 
  ...
  <style>
    ...
    .casino-card {
      background: linear-gradient(to right, #272525 0%, #272525 100%);
    }
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark p-2 font14 sticky-top">
    <a class="navbar-brand" href="index.php"><img src="img/sagame.png" height="40"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
      <ul class="navbar-nav ml-auto nav-flex-icons">
        <li class="nav-item">
          <a>
            <a data-toggle="modal" data-target="#info"><span class="nav-casino"><img src="img/user.png" style="height:25px;">&nbsp; <?= $Acc['user'] ?> &nbsp; </span>
          </a>
        </li>
...
<div class="modal fade" id="info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-md" role="document">
    ...
    <div class="modal-content" style="background-color:#272525; border:1px solid #b68933; border-radius:10px;">
      <div class="modal-body">
        <h4 class="text-center text-white">Member</h4>

        <div class="modal-body">
          <div class="container">

            <div class="row">
              <div id="detail_user" class="col-7 text-white">Username : <?= $Acc['user'] ?></div>
              <div id="showCreditM" class="col text-white">Credit : <?= $Acc['credit'] ?></div>
            </div>
          ...
          <div class="container text-center" style="width:70%">
            <form id="passChange" method="post">
             <div class="text-white"> <h4>Change Password</h4></div>
              <div class="text-white">Password</div>
              <div class="row mb-1">
                <input id="opass" type="password" name="opass" class="form-control input-sm" maxlength="32" minlength="6" pattern="^[a-zA-Z0-9_.-]+$" autocomplete="off" required="">
              </div>
              <div class="text-white ">New Password</div>
              <div class="row mb-1">
                <input id="npass" type="password" name="npass" class="form-control input-sm" maxlength="32" minlength="6" pattern="^[a-zA-Z0-9_.-]+$" autocomplete="off" required="">
              </div>
              <div class="text-white">Re-Type New Password</div>
              <div class="row mb-1">
                <input id="rnpass" type="password" name="rnpass" class="form-control input-sm" maxlength="32" minlength="6" pattern="^[a-zA-Z0-9_.-]+$" autocomplete="off" required="">
              </div>
              <br>
              <input type="submit" class="swal2-confirm swal2-styled" value="Submit">
            </form>
