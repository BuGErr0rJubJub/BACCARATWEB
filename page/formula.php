  ...
  <div class="row">
    <div class="col-sm">
      <div class="card casino-card p-5">
        ...
        <table class="table table-bordered table-dark" style="background: #202020;width: 410px; margin:0 auto;">
    <tbody>
        <?php
...
<div class="row text-white">
            <div class="col" style="padding:0">
              <span class="foottxt" id="per" style="padding-left:10%;">สถิติการถูกที่ผ่านมา</span>
...
function ez(){
	$.get( "https://newsa.zean.app/")	//https://newsa.zean.app/ http://103.208.27.143/sa_api.php
  .done(function( data ) {
